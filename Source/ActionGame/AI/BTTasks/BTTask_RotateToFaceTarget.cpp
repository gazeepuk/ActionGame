...
#include "AI/BTTasks/BTTask_RotateToFaceTarget.h"
...
FString UBTTask_RotateToFaceTarget::GetStaticDescription() const
{
	...
	return FString::Printf(TEXT("Smoothly rotates to face %s Key until the angle percision %s is reached"), *KeyDescription, *FString::SanitizeFloat(AnglePrecision));
}
